    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa Phòng Ban</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">Cập Nhật Thông Tin Phòng Ban</h5>
                <form action="{{ route('department.update', $department->id) }}" method="POST"
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="mytextarea" name="description">{{ $department->description }}</textarea>
                    </div>
