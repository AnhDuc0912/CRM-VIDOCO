$(document).ready(function () {
  ...
  $('#employee-create-form').validate({
    ...
    messages: {
      ...
      'contract[end_date]': {
        date: 'Vui lòng nhập ngày kết thúc hợp đồng hợp lệ',
        greaterOrEqualStart: 'Ngày kết thúc phải lớn hơn hoặc bằng ngày ký HĐ',
      },
      'salary[basic_salary]': {
  ...
  $.validator.addMethod('greaterOrEqualStart', function(value, element) {
