    ...
    <div class="card radius-15">
        <div class="card-body">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"> <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#upload_File"><span
                            class="p-tab-name">Upload File</span><i class='bx bx-message-edit font-24 d-sm-none'></i></a>
                </li>
            </ul>
