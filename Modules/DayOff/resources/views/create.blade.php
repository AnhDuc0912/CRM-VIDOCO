...
@section('title', 'Yêu cầu xin nghỉ')
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Yêu Cầu Đề Xuất Nghỉ Phép</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <form action="{{ route('dayoff.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="btn-group d-flex flex-wrap gap-2" role="group">
                                    <input type="radio" class="btn-check type-radio" name="type" id="type1"
                                        value="ke_hoach">
                                    <label class="btn btn-outline-info" for="type1">Kế hoạch</label>

                                    <input type="radio" class="btn-check type-radio" name="type" id="type2"
                                        value="lam_viec_o_nha">
                                    <label class="btn btn-outline-info" for="type2">Làm việc ở nhà</label>

                                    <input type="radio" class="btn-check type-radio" name="type" id="type3"
                                        value="ngoai_le">
                            ...
                            <!-- Hình thức (ngoại lệ) -->
                            <div class="mb-4 mode-section d-none">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="btn-group d-flex gap-2" role="group">
                                        ...
                                        <input type="radio" class="btn-check" name="session" id="session2"
                                            value="PM">
                                        <label class="btn btn-outline-danger" for="session2">PM</label>
                                        <input type="radio" class="btn-check" name="session" id="session3"
                                            value="FULL">
                                        <label class="btn btn-outline-danger" for="session3">Cả Ngày</label>
                                    </div>
                                </div>
                                <div class="col-md-4 time-section d-none">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="btn-group d-flex flex-wrap gap-2" role="group">
                                    <input type="radio" class="btn-check" name="reason_type" id="reason1"
                                        value="tac_duong">
                                    <label class="btn btn-outline-warning" for="reason1">Tắc đường</label>

                                    <input type="radio" class="btn-check" name="reason_type" id="reason2"
                                        value="nghi_om">
                                    <label class="btn btn-outline-warning" for="reason2">Nghỉ ốm</label>

                                    <input type="radio" class="btn-check" name="reason_type" id="reason3"
                                        value="viec_khan_cap">
                                    <label class="btn btn-outline-warning" for="reason3">Việc khẩn cấp</label>

                                    <input type="radio" class="btn-check" name="reason_type" id="reason4"
                                        value="khac">
