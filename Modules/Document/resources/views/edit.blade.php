                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('document.index') }}"><i class='bx bx-home-alt'></i></a>
                        </li>
                        <li class="breadcrumb-item active">Cập nhật văn bản</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div id="step-1">
                    ...
                    <button id="btn-step-1" class="btn btn-success w-100 mt-4">
                        Tiếp tục
                    </button>
                </div>
                ...
                <div id="step-2" style="display:none">
                    <form method="POST" action="{{ route('document.update', $document->id) }}"
                        ...
                        <div class="row mb-3 gx-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="structure-picker" data-type="storage">
                                    <input type="text" class="form-control structure-input" readonly>
                                    <input type="hidden" name="storage_id" id="storage_id"
                                        value="{{ $document->structures[0] ?? '' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="tag" class="form-control" value="{{ $document->tag }}">
                        </div>

                        <h5 class="fw-bold mt-4">Nội dung</h5>
                        <textarea name="content" rows="6" class="form-control">{{ $document->content }}</textarea>

                        <h5 class="fw-bold mt-4">Đính kèm</h5>
                        <input type="file" class="filepond" name="files[]" multiple>

                        <textarea name="bonus" rows="3" class="form-control mb-3">{{ $document->bonus }}</textarea>

                        <div class="row mb-4">
                            <div class="col-md-4">
                                <input type="date" name="issue_date" value="{{ $document->issue_date }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                                <input type="date" name="effective_date" value="{{ $document->effective_date }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                                <input type="date" name="expiration_date" value="{{ $document->expiration_date }}"
                                    class="form-control">
                            </div>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="{{ route('document.index') }}" class="btn btn-outline-secondary">Quay lại</a>
...
@push('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('type_id').value = type;
            document.getElementById('document_type_text').value = DOCUMENT_TYPE_LABEL[type];
