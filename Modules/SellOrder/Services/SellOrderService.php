...
class SellOrderService
{
    ...
    public function createSellOrder($data, $isConvertToOrder = false)
    {
        ...
        $orderData = [
            ...
            'sell_contract_id' => $data['sell_contract_id'] ?? null,
            'source_type' => $data['source_type'] ?? (($data['contract_id'] ?? null) ? 'contract' : (($data['proposal_id'] ?? null) ? 'proposal' : null)),
            'source_id' => $data['source_id'] ?? ($data['sell_contract_id'] ?? ($data['contract_id'] ?? ($data['proposal_id'] ?? null))),
