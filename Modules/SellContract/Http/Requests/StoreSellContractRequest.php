...
namespace Modules\SellContract\Http\Requests;

use Illuminate\Foundation\Http\FormRequest;
use Modules\SellContract\Enums\SellContractStatusEnum;

class StoreSellContractRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => 'required|in:' . implode(',', array_keys(SellContractStatusEnum::getStatusOptions())),
