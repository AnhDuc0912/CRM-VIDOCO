...
@section('content')
    <div class="card shadow-none border mb-0 radius-15">
        <div class="card-body">
            ...
            <hr />
            <form id="proposal-form" method="POST" action="{{ route('proposals.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (wasValid && customerId) {
                            ...
                            $('#customer_select').next('.select2-container').removeClass('is-invalid');
                            $('#customer_select').next('.select2-container').find('.select2-selection').removeClass('is-invalid');
                        }
                    }
                });
            });
