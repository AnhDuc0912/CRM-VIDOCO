$(document).ready(function () {
  ...
  $('#sell-order-form').on('submit', function (e) {
  ...
  function addServiceValidation(index) {
    const validator = $('#sell-order-form').validate();
  ...
  $(document).on(
    ...
    function () {
      ...
      $('#sell-order-form').validate().element($(this));
      ...
      if ($(this).hasClass('select2-product')) {
        ...
        setTimeout(function() {
          $('#sell-order-form').validate().element(priceInput);
  ...
  $(document).on(
    ...
    function () {
      ...
      if ($(this).hasClass('service-price')) {
        ...
        $('#sell-order-form').validate().element(element);
  ...
  $(document).on('click', '.remove-service', function() {
    setTimeout(function() {
      $('#sell-order-form').validate().resetForm();
  ...
  $(document).on('reset', '#sell-order-form', function() {
    setTimeout(function() {
      $('#sell-order-form').validate().resetForm();
      // Re-add validation for remaining services
      $('.service-row').each(function(index) {
  ...
  $(document).on('invalid-form.validate', '#sell-order-form', function() {
    setTimeout(restoreNumberFormat, 100);
  });

  $(document).on('valid-form.validate', '#sell-order-form', function() {
    setTimeout(restoreNumberFormat, 100);
  });
