(function ($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function (opts) {
    ...
    this.each(function () {
      ...
      let counter = 0;
      let dragbox = $(
        `<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Kéo & Thả File Vào Đây Để Tải Lên</span><button type="button"class="btn btn-default">Hoặc chọn file để tải lên</button></div></div>`
      );
